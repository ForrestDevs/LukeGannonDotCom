...
import { LinkIcon } from "@/components/standard/Icons";
...
const projects = [
  {
    title: "Gear Shed",
    description:
      "Track and Plan Outdoor Adventures with Gear Shed. Gear Shed is a web application that allows users to track their outdoor gear and plan trips with that gear.",
    link: {
      href: "https://www.gearshed.app",
      label: "Gear Shed App",
    },
    logo: {
      src: "project-logos/GS-WhiteTransparent.png",
      alt: "Burger",
    },
  },
];
    ...
    >
      {projects.map((project) => (
        <Card as="li" key={project.title}>
          <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-zinc-800 shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:ring-0">
            <Image
